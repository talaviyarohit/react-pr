                ...
                users.map((users) => {
                    ...
                    return (
                        <div className="container  ">
                            ...
                            <div className="col-5 border d-flex h-250 align-center bg main-card ">
                                <div className="col-6">
                                    <div className="img">
                                        <img src={users.image} alt="imtg" className="image" />
                                    </div>
                                </div>
                                <div className="col-6">
                                    <div className="pb-10">
                                        Username:-
                                        <span className="pr-20">{users.username}</span>
                                    </div>
                                    <div>
                                        Email:-
                                        <span className="pr-20">{users.email}</span>
                                    </div>
                                </div>
                                <div className="col-12">
                                    <div className=" ">
                                        <div className="pb-10">
                                            Name:-
                                            <span className="pr-20">{users.firstName}</span>
                                            <span className="pr-20">{users.lastName}</span>
                                            <span className="pr-20">{users.maidenName}</span>
                                        </div>
                                        <div className="pb-10">
                                            Contact:-
                                            <span className="pr-20">{users.phone}</span>

                                        </div>
                                        <div className="pb-10">
                                            D.O.B:-
                                            <span className="pr-20">{users.birthDate}</span>

                                        </div>
                                        <div className="pb-10">
                                            Address:-
                                            <span className="pr-20">{users.address.address}</span>
